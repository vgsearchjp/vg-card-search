...
{/* 前列左R */}
<div
 className="absolute top-[30%] left-[30%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:top-[23%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:left-[28%] flex flex-col items-center gap-2 cursor-pointer"
onClick={() => {
  if (selectedMoveSource === "waiting") {
...
{/* 前列右R */}
<div
  className="absolute top-[30%] right-[30%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:top-[23%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:right-[28%] flex flex-col items-center gap-2 cursor-pointer"
  onClick={() => {
    if (selectedMoveSource === "waiting") {
