...
<div
  ...
  className={`w-[45px] h-[65px] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:w-[60px] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:h-[88px] rounded overflow-hidden shrink-0 cursor-pointer ${
