...
{/* V */}
<div
  className="absolute top-[8%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:top-[11%] left-1/2 -translate-x-1/2 -translate-y-2 flex flex-col items-center gap-2 cursor-pointer"
onClick={() => {
if (selectedRZone === "frontLeft") {
  const rCard = frontLeftRCard;
