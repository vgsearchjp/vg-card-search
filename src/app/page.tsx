...
{/* ドロップ */}
<div
  className="absolute top-[55%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:top-[75%] right-[5.5%] [@media(min-width:768px)_and_(hover:hover)_and_(pointer:fine)]:right-[1%] z-20 flex items-center gap-3"
>
<div
onClick={() => {
  if (
